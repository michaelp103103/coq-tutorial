...
(* Or we could use auto: *)
Theorem add_0_r'' : forall n:nat, n + 0 = n.
Proof. Admitted.

(* 
We defined the 'day' type earlier:
...
Definition eq_d (d1 d2 : day) : bool :=
  match (d1, d2) with
  | (monday,monday) => true
...
(* How do we prove this? Tacticals! 
(Tacticals are tactics that act on other tactics) *)
Lemma test_eq_d : forall x : day, eq_d x x = true.
Proof. Admitted.
...
(*
  ...
  Or you can continue with Software Foundations:
